        ...
        <View className="bg-transparent">
            <View className="bg-transparent">
                <View className="flex flex-row bg-white w-full">
                    ...
                    <View className="bg-[#ff4c4c] w-4/12">
                        <View className="p-2 m-1 self-center">
                            <ThemedText className="text-white text-lg font-semibold">Expanse</ThemedText>
                        </View>
                    </View>
                    <View className="w-4/12 flex justify-center">
                ...
                <ThemedView className="flex mx-5 bg-transparent">
                    <View className="mt-2 p-4 bg-white rounded-lg">
                        ...
                        <View className="mt-3">
                            ...
                            <View className="flex flex-col">
                                <DropDownContainer placeholder="Select Category" type="categoryExpense" onSendData={handleDataFromCate}/>
                            </View>
                        </View>
                        <View className="mt-3">
